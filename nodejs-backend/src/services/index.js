...
const employeeDetails = require("./employeeDetails/employeeDetails.service.js");
const jobClassified = require("./jobClassified/jobClassified.service.js");
...
module.exports = function (app) {
  ...
  app.configure(employeeDetails);
  app.configure(jobClassified);
