...
import SingleEmployeeDetailsPage from "../components/EmployeeDetailsPage/SingleEmployeeDetailsPage";
import EmployeeDetailProjectLayoutPage from "../components/EmployeeDetailsPage/EmployeeDetailProjectLayoutPage";
import SingleJobClassifiedPage from "../components/JobClassifiedPage/SingleJobClassifiedPage";
import JobClassifiedProjectLayoutPage from "../components/JobClassifiedPage/JobClassifiedProjectLayoutPage";
// ~cb-add-import~
...
<Route path="/employeeDetails/:singleEmployeeDetailsId" exact element={<SingleEmployeeDetailsPage />} />
<Route path="/employeeDetails" exact element={<EmployeeDetailProjectLayoutPage />} />
<Route path="/jobClassified/:singleJobClassifiedId" exact element={<SingleJobClassifiedPage />} />
<Route path="/jobClassified" exact element={<JobClassifiedProjectLayoutPage />} />
