...
import JobClassifiedPage from "../JobClassifiedPage/JobClassifiedPage";
// ~cb-add-import~
...
<li
                onClick={() => {
                  setCurrentActiveTab2("employeeDetails");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "employeeDetails",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "employeeDetails" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "employeeDetails",
                      "text-black": props?.currentActiveTab2 !== "employeeDetails",
                    })}
                  >
                  EmployeeDetails
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "employeeDetails",
                      "text-yellow-700": props?.currentActiveTab2 !== "employeeDetails",
                    })}
                  >
...
<li
                onClick={() => {
                  setCurrentActiveTab2("jobClassified");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "jobClassified",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "jobClassified" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "jobClassified",
                      "text-black": props?.currentActiveTab2 !== "jobClassified",
                    })}
                  >
                  JobClassified
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "jobClassified",
                      "text-yellow-700": props?.currentActiveTab2 !== "jobClassified",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
